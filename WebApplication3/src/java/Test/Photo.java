...
public class Photo {
    ...
    public String convertCodeToLink(String code) throws ClassNotFoundException, InstantiationException, SQLException, IllegalAccessException {
        ...
        if (ts.verbindmetDatabase()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    link = "ftp://212.64.126.219:9942/Thumb" + thumbPath;
                }
                return link;
