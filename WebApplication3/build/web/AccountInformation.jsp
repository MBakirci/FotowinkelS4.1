        ...
        <div class="container">
            <%
                ...
                if (session.getAttribute("Role").equals("fotograaf")) {
                    if (request.getParameter("btnWM") != null) {
                        int wm = Integer.parseInt(request.getParameter("winstMarge"));
                        user.SetProfitMargin(wm);
                    }
                }
            %>
                ...
                <form>
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            <input type="number" name="winstMarge" class="form-control" id="winstMarge" placeholder="<%=user.GetProfitMargin()%>%" required>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12"> 
                            <button type="submit" name="btnWM" class="btn btn-default">Pas aan</button>
                        </div>
                    </div>
                </form>
                <%}%>
